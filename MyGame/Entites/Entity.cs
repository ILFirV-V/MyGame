...
//                currentFrame += 2;
//            else currentFrame = 0;
//            g.DrawImage(spriteSheet, new Rectangle(new Point(posX - direction * size / 2, posY), new Size(direction * size * 2, size * 2)), 22 + 32 * currentFrame, 8 +  32 * currentAnimation, size, size, GraphicsUnit.Pixel);
//        }
